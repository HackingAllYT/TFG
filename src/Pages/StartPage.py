...
class StartPage(tk.Frame):
    ...
    def __init_HD__(self, controller):
        ...
        route = self.config['INITIAL']['RESOLU'] + '/entry_1.png'
        ...
        route = self.config['INITIAL']['RESOLU'] + '/folder.png'
        ...
        route = self.config['INITIAL']['RESOLU'] + '/citius.png'
    ...
    *******************************************************************************
    ...
    def button_1_enter(self, e):
        name = self.config['INITIAL']['RESOLU'] + '/folder.png'
        aux = PhotoImage(
