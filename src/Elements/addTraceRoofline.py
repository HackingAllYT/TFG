...
from src.config.text import TEXT, TREETYPE_TIDs_PIDs, TREETYPE_CPUs
...
class TraceRoofline(tk.Frame):
    ...
    def __init__(self, parent, controller, classParent, **kw):
        ...
        self.entry_image_1 = PhotoImage(
            file=self.relative_to_assets("entry_roofline_1.png"))
        ...
        self.entry_image_2 = PhotoImage(
            file=self.relative_to_assets("entry_roofline_2.png"))
