...
from src.config.text import TEXT
...
class selectFigureModal(tk.Toplevel):
    def __init__(self, parent, suggestions):
        ...
        self.relative_to_assets = self.parent.relative_to_assets
        ...
        self.button_image_2 = PhotoImage(
            file=self.relative_to_assets("button_heatmap.png"))
        ...
        self.button_image_3 = PhotoImage(
            file=self.relative_to_assets("button_scatter.png"))
        ...
        '''self.button_image_4 = PhotoImage(
            file=self.relative_to_assets("roofline_model.png"))
        ...
        self.button_image_5 = PhotoImage(
            file=self.relative_to_assets("button_scatter_temporal.png"))
